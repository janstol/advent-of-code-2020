...
**numbers**. They begin by taking turns reading from a list of 
**starting numbers** (your puzzle input). Then, each turn consists of considering the 
...
**`2020`th** number spoken? In the example above, the `2020`th number spoken will be `436`.
